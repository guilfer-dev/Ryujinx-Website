...
<template>
	<Component
:is="componentType" v-if="componentType !== 'router-link' || disabled" :to="attributes" :href="href"
		:type="type" :disabled="disabled" :class="componentClass" target="_blank" @click="onClick">
		<slot name="loading-icon">
			<RefreshIcon v-if="loading" class="motion-reduce:hidden animate-spin -ml-1 mr-3 h-5 w-5 text-white" />
		</slot>
